...
const GITHUB_ICON = 'M12 .5C5.65.5.5 5.65.5 12c0 5.07 3.29 9.36 7.86 10.88.58.1.79-.25.79-.56 0-.28-.01-1.02-.02-2-3.2.7-3.87-1.54-3.87-1.54-.52-1.34-1.28-1.7-1.28-1.7-1.04-.71.08-.7.08-.7 1.15.08 1.76 1.18 1.76 1.18 1.03 1.76 2.7 1.25 3.36.95.1-.74.4-1.25.73-1.54-2.55-.29-5.24-1.28-5.24-5.7 0-1.26.45-2.3 1.18-3.1-.12-.29-.51-1.46.11-3.05 0 0 .97-.31 3.18 1.18a11.04 11.04 0 0 1 5.8 0c2.2-1.49 3.17-1.18 3.17-1.18.63 1.59.24 2.76.12 3.05.74.8 1.18 1.84 1.18 3.1 0 4.43-2.69 5.41-5.26 5.7.41.36.78 1.06.78 2.13 0 1.54-.01 2.78-.01 3.16 0 .31.21.67.79.56C20.21 21.36 23.5 17.07 23.5 12 23.5 5.65 18.35.5 12 .5z'
const GIT_ICON = 'M23.546 10.93 13.067.452a1.55 1.55 0 0 0-2.188 0L8.708 2.624l2.76 2.76a1.84 1.84 0 0 1 1.889.441 1.84 1.84 0 0 1 .438 1.9l2.658 2.66a1.84 1.84 0 0 1 1.9.435 1.842 1.842 0 1 1-3.008.608l-2.477-2.478v6.525c.176.087.342.203.488.348a1.842 1.842 0 1 1-2.604 0c.177-.176.378-.312.595-.404V8.835a1.84 1.84 0 0 1-.996-2.413L7.636 3.657.45 10.842a1.55 1.55 0 0 0 0 2.188l10.478 10.478a1.55 1.55 0 0 0 2.188 0l10.43-10.39a1.55 1.55 0 0 0 0-2.188z'

export const PLATFORMS = [
  { code: 'github', icon: GITHUB_ICON },
  { code: 'gitcode', icon: GIT_ICON },
  { code: 'gitee', icon: GIT_ICON }
]
